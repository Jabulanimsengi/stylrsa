...
import AdminAllSellersSection from './components/AdminAllSellersSection';
    ...
    <>
      ...
      >
        ...
        <div className={styles.list}>
          ...
          {view === 'all-sellers' && (
            <AdminAllSellersSection
              sellers={allSellers}
              sellerFilter={sellerFilter}
              onSellerFilterChange={setSellerFilter}
              expandedItems={expandedItems}
              updatingSellerPlanId={updatingSellerPlanId}
              toggleExpanded={toggleExpanded}
              copyToClipboard={copyToClipboard}
              updateSellerApprovalStatus={updateSellerApprovalStatus}
              updateSellerPaymentStatus={updateSellerPaymentStatus}
              openDeleteSellerModal={openDeleteSellerModal}
            />
          )}
