...
export default function Login({ onLoginSuccess }: LoginProps) {
  ...
  return (
    <div>
      ...
      <div className={`${styles.oauthDivider} ${styles.oauthDividerPlain}`}>or use email</div>
      <p className={styles.oauthHelperText}>
        Use Google for the fastest sign-in, or continue with email and verify using a 6-digit code.
      </p>
