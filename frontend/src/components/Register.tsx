    ...
    <div>
      {step === 'account' && (
        <>
          ...
          <p className={styles.oauthHelperText}>
            We will send a 6-digit verification code to your email before your first sign-in.
          </p>
        </>
      )}
      <form className={styles.form} onSubmit={handleSubmit}>
        ...
        <div className={styles.stepActions}>
          ...
          {step === 'account' ? (
            <Button type="button" className="w-full" disabled={isGoogleLoading} onClick={handleContinue}>
              Continue
            </Button>
          ) : (
            <LoadingButton
