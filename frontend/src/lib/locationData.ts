...
export const PROVINCES: Record<string, ProvinceInfo> = {
  ...
  'north-west': {
    slug: 'north-west',
    name: 'North West',
    description: 'Find top-rated salons, spas, and beauty professionals in the North West province. Book appointments at the best hair salons, nail salons, and wellness centers in Rustenburg, Potchefstroom, and Mahikeng.',
    keywords: ['North West salons', 'Rustenburg beauty', 'Potchefstroom hair salon', 'North West spa', 'Mahikeng nail salon'],
    cities: [
      {
        slug: 'rustenburg',
        name: 'Rustenburg',
        province: 'North West',
        description: 'Discover premium salons and beauty services in Rustenburg. Book appointments at top-rated hair salons, nail studios, and spas in the Platinum City.',
        keywords: ['hair salon near me Rustenburg', 'nail salon Rustenburg', 'spa Rustenburg', 'beauty salon Rustenburg'],
      },
      {
        slug: 'potchefstroom',
        name: 'Potchefstroom',
        province: 'North West',
        description: 'Find quality salons and beauty services in Potchefstroom. Book at trusted hair salons, nail studios, and beauty centers in Potch.',
        keywords: ['hair salon near me Potchefstroom', 'nail salon Potchefstroom', 'beauty salon Potch', 'student salon Potchefstroom'],
      },
      {
        slug: 'klerksdorp',
        name: 'Klerksdorp',
        province: 'North West',
        description: 'Discover salons in Klerksdorp. Book at local hair salons, nail studios, and beauty professionals.',
        keywords: ['hair salon near me Klerksdorp', 'nail salon Klerksdorp', 'beauty salon Klerksdorp', 'spa Klerksdorp'],
      },
      {
        slug: 'brits',
        name: 'Brits',
        province: 'North West',
        description: 'Find salons in Brits. Book at hair salons, nail studios, and beauty centers.',
        keywords: ['hair salon near me Brits', 'nail salon Brits', 'beauty salon Brits'],
      },
      {
        slug: 'mahikeng',
        name: 'Mahikeng',
        province: 'North West',
        description: 'Discover salons in Mahikeng (Mafikeng). Book hair salons, braiding, and beauty services in the capital.',
        keywords: ['hair salon Mahikeng', 'nail salon Mafikeng', 'beauty salon Mahikeng', 'braids Mahikeng'],
      },
      {
        slug: 'hartbeespoort',
        name: 'Hartbeespoort',
        province: 'North West',
        description: 'Find luxury salons and spas in Hartbeespoort. Book premium beauty services near the dam.',
        keywords: ['spa Hartbeespoort', 'hair salon Hartbeespoort', 'beauty salon Harties', 'weekend spa Hartbeespoort'],
      },
      {
        slug: 'sun-city',
        name: 'Sun City',
        province: 'North West',
        description: 'Discover luxury resort salons and spas at Sun City. Book premium treatments and beauty services.',
        keywords: ['spa Sun City', 'hair salon Sun City', 'luxury beauty Sun City'],
      },
      {
        slug: 'lichtenburg',
        name: 'Lichtenburg',
        province: 'North West',
        description: 'Find salons in Lichtenburg. Book hair salons, nail studios, and beauty services.',
        keywords: ['hair salon Lichtenburg', 'nail salon Lichtenburg', 'beauty salon Lichtenburg'],
      },
      {
        slug: 'orkney',
        name: 'Orkney',
        province: 'North West',
        description: 'Discover salons in Orkney. Book at local hair salons and beauty professionals.',
        keywords: ['hair salon Orkney', 'nail salon Orkney', 'beauty salon Orkney'],
      },
      {
        slug: 'stilfontein',
        name: 'Stilfontein',
        province: 'North West',
        description: 'Find salons in Stilfontein. Book at hair salons and beauty services.',
        keywords: ['hair salon Stilfontein', 'nail salon Stilfontein', 'beauty salon Stilfontein'],
      },
    ],
  },
  'kwazulu-natal': {
    ...
    keywords: ['KZN salons', 'Durban beauty', 'Pietermaritzburg hair salon', 'KZN spa', 'Umhlanga nail salon'],
    cities: [
      {
        slug: 'durban',
        name: 'Durban',
        ...
        keywords: ['hair salon Durban', 'nail salon Durban', 'beauty salon Durban', 'spa Durban'],
      },
      {
        slug: 'umhlanga',
        name: 'Umhlanga',
        province: 'KwaZulu-Natal',
        description: 'Find luxury salons in Umhlanga. Book premium hair salons, spas, and beauty services.',
        keywords: ['spa Umhlanga', 'hair salon Umhlanga', 'nails Umhlanga Ridge'],
      },
      {
        slug: 'ballito',
        name: 'Ballito',
        province: 'KwaZulu-Natal',
        description: 'Discover salons in Ballito. Book hair salons, nail studios, and beauty services on the Dolphin Coast.',
        keywords: ['salon Ballito', 'hair salon Ballito', 'beauty salon Ballito'],
      },
      {
        slug: 'pietermaritzburg',
        name: 'Pietermaritzburg',
        province: 'KwaZulu-Natal',
        description: 'Find salons in Pietermaritzburg. Book hair salons, nail studios, and beauty services in the capital.',
        keywords: ['hair salon Pietermaritzburg', 'nail salon PMB', 'beauty salon Pietermaritzburg'],
      },
      {
        slug: 'richards-bay',
        name: 'Richards Bay',
        province: 'KwaZulu-Natal',
        description: 'Discover salons in Richards Bay. Book hair salons and beauty services.',
        keywords: ['hair salon Richards Bay', 'beauty salon Richards Bay', 'nails Richards Bay'],
      },
      {
        slug: 'newcastle',
        name: 'Newcastle',
        province: 'KwaZulu-Natal',
        description: 'Find salons in Newcastle. Book hair salons, nail studios, and beauty professionals.',
        keywords: ['hair salon Newcastle KZN', 'beauty salon Newcastle', 'nails Newcastle'],
      },
      {
        slug: 'amanziimtoti',
        name: 'Amanzimtoti',
        province: 'KwaZulu-Natal',
        description: 'Discover salons in Amanzimtoti. Book hair salons and beauty services.',
        keywords: ['hair salon Amanzimtoti', 'beauty salon Toti', 'nails Amanzimtoti'],
      },
    ],
  },
  'eastern-cape': {
    slug: 'eastern-cape',
    name: 'Eastern Cape',
    description: 'Find top-rated salons and spas in the Eastern Cape. Book appointments in Port Elizabeth (Gqeberha), East London, and surrounds.',
    keywords: ['Eastern Cape salons', 'Port Elizabeth hair salon', 'East London beauty', 'Gqeberha spa'],
    cities: [
      {
        slug: 'port-elizabeth',
        name: 'Port Elizabeth',
        province: 'Eastern Cape',
        description: 'Discover salons in Port Elizabeth (Gqeberha). Book hair salons, nail studios, and beauty services.',
        keywords: ['hair salon Port Elizabeth', 'nail salon Gqeberha', 'beauty salon PE', 'spa Port Elizabeth'],
      },
      {
        slug: 'east-london',
        name: 'East London',
        province: 'Eastern Cape',
        description: 'Find salons in East London. Book hair salons, nail studios, and beauty services in Buffalo City.',
      ...
      },
      {
        ...
        name: 'Jeffreys Bay',
        province: 'Eastern Cape',
        description: 'Discover salons in Jeffreys Bay. Book hair salons and beauty services.',
        keywords: ['hair salon Jeffreys Bay', 'beauty salon JBay', 'nails Jeffreys Bay'],
      },
      {
        slug: 'grahamstown',
        name: 'Grahamstown',
        province: 'Eastern Cape',
        description: 'Find salons in Grahamstown (Makhanda). Book hair salons and beauty services.',
        keywords: ['hair salon Grahamstown', 'beauty salon Makhanda', 'nails Grahamstown'],
      },
      {
        slug: 'uitenhage',
        name: 'Uitenhage',
        province: 'Eastern Cape',
        description: 'Discover salons in Uitenhage (Kariega). Book hair salons and beauty services.',
        keywords: ['hair salon Uitenhage', 'beauty salon Kariega', 'nails Uitenhage'],
      },
    ],
  },
  'free-state': {
    slug: 'free-state',
    name: 'Free State',
    description: 'Find top-rated salons and beauty professionals in the Free State. Book appointments in Bloemfontein, Welkom, and Sasolburg.',
    keywords: ['Free State salons', 'Bloemfontein beauty', 'Welkom hair salon', 'Free State spa'],
    cities: [
      {
        slug: 'bloemfontein',
        name: 'Bloemfontein',
        province: 'Free State',
        description: 'Discover salons in Bloemfontein. Book hair salons, nail studios, and beauty services in the City of Roses.',
      ...
      },
      {
        ...
        name: 'Welkom',
        province: 'Free State',
        description: 'Find salons in Welkom. Book hair salons, nail studios, and beauty services.',
      ...
      },
      {
        ...
        keywords: ['hair salon Sasolburg', 'beauty salon Sasolburg', 'nails Sasolburg'],
      },
      {
        slug: 'bethlehem',
        name: 'Bethlehem',
        province: 'Free State',
        description: 'Find salons in Bethlehem. Book hair salons and beauty services.',
        keywords: ['hair salon Bethlehem', 'beauty salon Bethlehem', 'nails Bethlehem'],
      },
      {
        slug: 'parys',
        name: 'Parys',
        province: 'Free State',
        description: 'Discover salons in Parys. Book hair salons, spas, and beauty services.',
        keywords: ['hair salon Parys', 'spa Parys', 'beauty salon Parys'],
      },
    ],
  },
  'mpumalanga': {
    slug: 'mpumalanga',
    name: 'Mpumalanga',
    description: 'Find top-rated salons and spas in Mpumalanga. Book appointments in Nelspruit (Mbombela), Witbank, and Secunda.',
    keywords: ['Mpumalanga salons', 'Nelspruit beauty', 'Witbank hair salon', 'Mpumalanga spa'],
    cities: [
      {
        slug: 'nelspruit',
        name: 'Nelspruit',
        province: 'Mpumalanga',
        description: 'Discover salons in Nelspruit (Mbombela). Book hair salons, nail studios, and beauty services.',
        keywords: ['hair salon Nelspruit', 'nail salon Mbombela', 'beauty salon Nelspruit', 'spa Nelspruit'],
      },
      {
        slug: 'witbank',
        name: 'Witbank',
        province: 'Mpumalanga',
        description: 'Find salons in Witbank (Emalahleni). Book hair salons and beauty services.',
        keywords: ['hair salon Witbank', 'nail salon Emalahleni', 'beauty salon Witbank'],
      },
      {
        slug: 'secunda',
        name: 'Secunda',
        province: 'Mpumalanga',
        description: 'Discover salons in Secunda. Book hair salons and beauty services.',
        keywords: ['hair salon Secunda', 'beauty salon Secunda', 'nails Secunda'],
      },
      {
        slug: 'middelburg',
        name: 'Middelburg',
        province: 'Mpumalanga',
        description: 'Find salons in Middelburg. Book hair salons and beauty services.',
        keywords: ['hair salon Middelburg', 'beauty salon Middelburg', 'nails Middelburg'],
      },
      {
        slug: 'white-river',
        name: 'White River',
        ...
        keywords: ['hair salon White River', 'beauty salon White River', 'nails White River'],
      },
    ],
  },
  'limpopo': {
    slug: 'limpopo',
    name: 'Limpopo',
    description: 'Find top-rated salons and beauty professionals in Limpopo. Book appointments in Polokwane, Tzaneen, and Thohoyandou.',
    keywords: ['Limpopo salons', 'Polokwane beauty', 'Tzaneen hair salon', 'Limpopo spa'],
    cities: [
      {
        slug: 'polokwane',
        name: 'Polokwane',
        province: 'Limpopo',
        description: 'Discover salons in Polokwane (Pietersburg). Book hair salons, nail studios, and beauty services.',
        keywords: ['hair salon Polokwane', 'nail salon Polokwane', 'beauty salon Polokwane', 'spa Polokwane'],
      },
      {
        slug: 'tzaneen',
        name: 'Tzaneen',
        province: 'Limpopo',
        description: 'Find salons in Tzaneen. Book hair salons and beauty services.',
        keywords: ['hair salon Tzaneen', 'beauty salon Tzaneen', 'nails Tzaneen'],
      },
      {
        slug: 'thohoyandou',
        name: 'Thohoyandou',
        province: 'Limpopo',
        description: 'Discover salons in Thohoyandou. Book hair salons and beauty services.',
        keywords: ['hair salon Thohoyandou', 'beauty salon Thohoyandou', 'nails Thohoyandou'],
      },
      {
        slug: 'mokopane',
        name: 'Mokopane',
        ...
        keywords: ['hair salon Mokopane', 'beauty salon Mokopane', 'nails Mokopane'],
      },
      {
        slug: 'phalaborwa',
        name: 'Phalaborwa',
        province: 'Limpopo',
        description: 'Discover salons in Phalaborwa. Book hair salons and beauty services.',
        keywords: ['hair salon Phalaborwa', 'beauty salon Phalaborwa', 'nails Phalaborwa'],
      },
    ],
  },
  'northern-cape': {
    slug: 'northern-cape',
    name: 'Northern Cape',
    description: 'Find top-rated salons and beauty professionals in the Northern Cape. Book appointments in Kimberley and Upington.',
    keywords: ['Northern Cape salons', 'Kimberley beauty', 'Upington hair salon'],
    cities: [
      {
        slug: 'kimberley',
        name: 'Kimberley',
        province: 'Northern Cape',
        description: 'Discover salons in Kimberley. Book hair salons, nail studios, and beauty services.',
      ...
      },
      {
        ...
        name: 'Upington',
        province: 'Northern Cape',
        description: 'Find salons in Upington. Book hair salons and beauty services.',
        keywords: ['hair salon Upington', 'beauty salon Upington', 'nails Upington'],
      },
      {
        slug: 'kathu',
        name: 'Kathu',
        province: 'Northern Cape',
        description: 'Discover salons in Kathu. Book hair salons and beauty services.',
        keywords: ['hair salon Kathu', 'beauty salon Kathu', 'nails Kathu'],
      },
      {
        slug: 'kuruman',
        name: 'Kuruman',
        province: 'Northern Cape',
        description: 'Find salons in Kuruman. Book hair salons and beauty services.',
        keywords: ['hair salon Kuruman', 'beauty salon Kuruman', 'nails Kuruman'],
      },
      {
        slug: 'springbok',
        name: 'Springbok',
        province: 'Northern Cape',
        description: 'Discover salons in Springbok. Book hair salons and beauty services.',
        keywords: ['hair salon Springbok', 'beauty salon Springbok', 'nails Springbok'],
      },
    ],
  },
};
